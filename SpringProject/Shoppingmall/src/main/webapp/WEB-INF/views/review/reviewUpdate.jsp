					...
					<div id="main">
						...
						<!-- Post -->
							<section class="post">
								...
								<form method="post" action="/shoppingmall/review/reviewUpdate" id="frm" enctype="multipart/form-data">
									<input type="hidden" name="cnum" id="cnum" value="${review.cnum}">
									
									<div class="row gtr-uniform">

										<div class="col-6 col-12-xsmall">
											<input type="text" placeholder="이름" name="name" id="name" value="${review.name}"/>
										</div>
										...
										<!-- Break -->
										<div class="col-12">
											<textarea placeholder="내용을 입력하세요" rows="6" name="comment" id="comment" required>${review.comment}</textarea>
										</div>
