					...
					<div id="main">
						...
						<!-- Post -->
							<section class="post">
								...
								<form method="post" action="/shoppingmall/member/update" id="frm">
									<div class="form-group">
									  <label for="id"> Id:</label>
									  <input type="text" class="form-control" placeholder="아이디를 입력하세요" id="mId" name="mId" value="${memberId }" required="required">
									...
									<div class="form-group">
									  ...
									  <div class="form-group">
										<div class="form-group">
											...
											<input type="text" class="form-control" placeholder="이름을 입력하세요" id="mName" name="mName" value="${memberName }" required="required" >
										  </div>
										<label for="tel">전화번호:</label>
										<input type="tel" class="form-control" placeholder="전화번호를 입력하세요" id="mTel" name="mTel" value="${memberTel }" required="required" >
									  </div>
									  <div class="form-group">
										<label for="email">이메일:</label>
										<input type="email" class="form-control" placeholder="이메일을 입력하세요" id="mEmail" name="mEmail" value="${memberEmail }" required="required" >
									  </div>

									  <div class="form-group">
										<label for="addr">주소:</label>
										<input type="text" class="form-control" placeholder="주소를 입력하세요" id="mAddress" name="mAddress" value="${memberAddress }" required="required" >
									  </div>

									<div class="col-12">
										<ul class="actions">
											<li><a href="/shoppingmall/member/mypage" class="button primary fit">되돌아가기</a></li>
											<li><button type="button" class="button primary fit" id="send">회원 수정 하기</button></li>
							
											<li><button type="button" onclick="del('${memberId }')" class="button primary fit">회원 탈퇴 하기</button></li>
...
function del(id){
	//alert(id);
	if(confirm(id+"님 정말 탈퇴하시겠습니까?")){
		location.href="/shoppingmall/member/delete?mId="+id;
	}
